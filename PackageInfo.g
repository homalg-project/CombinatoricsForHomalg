#############################################################################
##  
##  PackageInfo.g for the package `CombinatoricsForHomalg'
##
...
#
PackageName := "CombinatoricsForHomalg",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "CombinatoricsForHomalg - CombinatoricsForHomalg constructions for homalg",

##  See '?Extending: Version Numbers' in GAP help for an explanation
##  of valid version numbers. For an automatic package distribution update
##  you must provide a new version number even after small changes.
Version := Maximum( [
  "2013.05.06", ## Mohamed's version
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/homalg/CombinatoricsForHomalg-", ~.Version ),
...
#
README_URL := 
  "http://wwwb.math.rwth-aachen.de/~barakat/gap/CombinatoricsForHomalg/README.CombinatoricsForHomalg",
PackageInfoURL := 
  "http://wwwb.math.rwth-aachen.de/~barakat/gap/CombinatoricsForHomalg/PackageInfo.g",
...
PackageDoc := rec(
  # use same as in GAP            
  BookName  := "CombinatoricsForHomalg",
  # format/extension can be one of .zoo, .tar.gz, .tar.bz2, -win.zip
  Archive := 
    "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/CombinatoricsForHomalg/CombinatoricsForHomalg.tar.gz",
  ...
  LongTitle := "CombinatoricsForHomalg - CombinatoricsForHomalg constructions for homalg",
...
Keywords := [ "CombinatoricsForHomalg Ext", "CombinatoricsForHomalg cocycles", "CombinatoricsForHomalg products", "Massey products" ]
